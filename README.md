...
1. 仕様ファイル(.ts)をドラッグ&ドロップするか、ワンクリックデモ(tutorial-withdraw / payment-retry / order-payment / doc-permission / conduit-favorite-count / conduit-comment-delete)を読み込む
...
はじめての場合は [docs/tutorial.md](docs/tutorial.md) から読む(最初の1仕様を書いて検査するまで、およそ40分)。DSLの全機能は [docs/dsl-sketch.md](docs/dsl-sketch.md)(状態機械)、[docs/datamodel-sketch.md](docs/datamodel-sketch.md)(データモデル・権限)と [examples/](examples/) を参照。
